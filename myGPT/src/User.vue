...
const saveProfileChanges = () => {
    axios.post("http://47.99.133.237:8080/user/updateUserProfile"
        , {
...
const updatePassword = () => {
    ...
    axios.put(
        "http://47.99.133.237:8080/user/updatePassword",
...
function getUserProfile() {
    ...
    axios
        .get("http://47.99.133.237:8080/user/getUserProfile", {
            withCredentials: true,
            params: {
                userID: userID,
            },
...
function handleUpdateUserSettings(model, prompt) {
    axios.put("http://47.99.133.237:8080/user/updateUserSettings", {
        userID: user.value.userID,
        defaultModel: model,
