            ...
            <el-col :span="6">
                <div class="param-item">
                    <el-tooltip placement="top">
                        ...
                        <el-input v-model="system" placeholder="system" size="small" :disabled="currentChatID !== -1">
                        </el-input>
                    </el-tooltip>
                </div>
            </el-col>
...
function aiChat() {
    ...
    // 携带cookie发送请求
    const source = new EventSource("http://47.99.133.237:8080/aiChat?inputValue=" + inputValue.value +
        "&chatID=" + chatID +
